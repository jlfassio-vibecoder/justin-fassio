...
-- ─────────────────────────────────────────────────────────────────────────
-- account_invoices — imported Vintage Goods PDF line history per account.
-- ─────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────
-- account_research_source_locks (staff-picked official URL per retailer + source)
-- ─────────────────────────────────────────────────────────────────────────
...
create table if not exists account_research_citations (
  ...
  acceptance_basis text
    check (acceptance_basis is null or acceptance_basis in ('identity_gate', 'staff', 'confirmed_profile')),
...
-- Account Research PR4: persist product match run RPC.
