    ...
    <section className="flex flex-col gap-5" data-screen-label="dashboard">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_2fr]">
        <Card>
          ...
          <div className="mt-1.5 rounded-md bg-bg p-3 text-xs">
            ...
            <p className="opacity-80">Log prospect calls to calculate real-time product-market-fit intelligence.</p>
          </div>
        </Card>
        ...
        <Card>
          ...
          <div className="mt-1.5 grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[13px] opacity-60">No channel data yet — appears once calls are logged.</p>
            </div>
            <div className="flex flex-col gap-2">
              <p className="text-[11px] uppercase tracking-wider opacity-60">Outcomes</p>
              <p className="text-[13px] opacity-60">No outcomes yet — appears once calls are logged.</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card elevation="md" className="items-center gap-2.5 px-5 py-10 text-center">
        ...
        <p className="max-w-[44ch] text-[13px] opacity-70">
          Your latest prospect calls will show here — store, channel, outcome, PMF score and order value at a
          glance.
        </p>
